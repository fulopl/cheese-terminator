...
import com.codecool.dungeoncrawl.ui.elements.VictoryMessage;
...
public class UI {
    ...
    public void refresh() {
        logic.getMap().getEnemyList().forEach(Actor::move);
        ...
        mainStage.setEnemyHealthValueText(logic.getEnemyHealth());
        mainStage.setEnemyDamageValueText(logic.getEnemyDamage());
        mainStage.setInventoryText(logic.getPlayerInventory());
